...
const breakdownsByTier: Record<string, PriceBreakdownItem[]> = {
  "2000": [
    { label: "Custom Design & Layout", value: "$600" },
    { label: "5 Responsive Pages", value: "$300" },
    { label: "Mobile Optimization", value: "Included" },
    { label: "Basic SEO Setup", value: "$150" },
    { label: "Contact Form & Map Integration", value: "$150" },
    { label: "Performance Optimization", value: "Included" },
    { label: "Hosting Setup & Deployment", value: "$200" },
    { label: "Domain & SSL Setup", value: "$300" },
    { label: "30-Day Support", value: "$300" },
  ],
  "3000": [
    { label: "Custom Design & Development", value: "$900" },
    { label: "6 Responsive Pages", value: "$400" },
    { label: "Mobile-First Design", value: "Included" },
    { label: "SEO Optimization Package", value: "$300" },
    { label: "Interactive Features", value: "$250" },
    { label: "CMS Integration", value: "$250" },
    { label: "Hosting & Deployment", value: "$300" },
    { label: "Domain & SSL Setup", value: "$200" },
    { label: "60-Day Support", value: "$400" },
  ],
  "4000": [
    { label: "Professional Design & Dev", value: "$1,200" },
    { label: "6–8 Responsive Pages", value: "$500" },
    { label: "Mobile-First Design", value: "Included" },
    { label: "SEO Optimization Suite", value: "$350" },
    { label: "Booking / Reservation System", value: "$300" },
    { label: "CMS Integration", value: "$250" },
    { label: "Analytics & Tracking Setup", value: "Included" },
    { label: "Hosting & Deployment", value: "$400" },
    { label: "60-Day Priority Support", value: "$500" },
    { label: "Content Strategy Session", value: "$500" },
  ],
  "5500": [
    { label: "Premium Design & Development", value: "$1,600" },
    { label: "8–10 Responsive Pages", value: "$750" },
    { label: "Mobile-First Design", value: "Included" },
    { label: "Advanced SEO & Analytics", value: "$500" },
    { label: "Custom Animations & Interactions", value: "$400" },
    { label: "CMS with Blog Integration", value: "$350" },
    { label: "Performance Optimization", value: "Included" },
    { label: "Hosting & Deployment", value: "$400" },
    { label: "90-Day Priority Support", value: "$600" },
    { label: "Brand Strategy Consultation", value: "$400" },
    { label: "Security & SSL Setup", value: "$300" },
    { label: "Content Migration Assistance", value: "$200" },
  ],
  "7000": [
    { label: "Premium Custom Design", value: "$2,000" },
    { label: "10+ Responsive Pages", value: "$900" },
    { label: "Mobile-First Design", value: "Included" },
    { label: "Advanced SEO & Schema Markup", value: "$600" },
    { label: "Booking / Appointment System", value: "$500" },
    { label: "Custom CMS Dashboard", value: "$500" },
    { label: "Analytics & Reporting Dashboard", value: "$400" },
    { label: "Performance & Security Audit", value: "Included" },
    { label: "Hosting & Deployment", value: "$500" },
    { label: "90-Day Priority Support", value: "$800" },
    { label: "Copywriting & Brand Consultation", value: "$500" },
    { label: "Ongoing Maintenance Setup", value: "$300" },
  ],
  "8500": [
    { label: "Advanced Custom Development", value: "$2,500" },
    { label: "12+ Responsive Pages", value: "$1,000" },
    { label: "Mobile-First Responsive Design", value: "Included" },
    { label: "Advanced SEO & Local SEO", value: "$700" },
    { label: "Listings / Dashboard System", value: "$1,000" },
    { label: "Interactive Maps & Search", value: "$500" },
    { label: "Custom CMS & Admin Panel", value: "$600" },
    { label: "Analytics & Lead Tracking", value: "$500" },
    { label: "Performance & Security Audit", value: "Included" },
    { label: "Hosting & Deployment", value: "$500" },
    { label: "120-Day Priority Support", value: "$900" },
    { label: "Strategy & Launch Consultation", value: "$300" },
  ],
  "10000": [
    { label: "E-Commerce Design & Development", value: "$3,000" },
    { label: "Product Pages & Catalog System", value: "$1,200" },
    { label: "Payment Gateway (Stripe / PayPal)", value: "$800" },
    { label: "Shopping Cart & Checkout Flow", value: "$800" },
    { label: "Inventory & Order Management", value: "$700" },
    { label: "Customer Accounts & Wishlist", value: "$500" },
    { label: "Mobile Shopping Experience", value: "Included" },
    { label: "SEO & Product Schema Markup", value: "$500" },
    { label: "Performance & Security Audit", value: "Included" },
    { label: "Hosting & Deployment", value: "$600" },
    { label: "120-Day Priority Support", value: "$1,000" },
    { label: "Launch Strategy & Marketing Setup", value: "$400" },
    { label: "Email Marketing Integration", value: "$500" },
  ],
};
