...
// Price breakdowns by tier — concise highlights of what's included
const breakdownsByTier: Record<string, PriceBreakdownItem[]> = {
  "2000": [
    { label: "Custom Design & Layout", value: "$800" },
    { label: "5 Responsive Pages", value: "$400" },
    { label: "Basic SEO & Contact Forms", value: "$300" },
    { label: "Hosting, Domain & SSL", value: "$200" },
    { label: "30-Day Support", value: "$300" },
  ],
  "3000": [
    { label: "Custom Design & Development", value: "$1,100" },
    { label: "6 Pages + CMS Integration", value: "$650" },
    { label: "SEO & Interactive Features", value: "$550" },
    { label: "Hosting & Deployment", value: "$300" },
    { label: "60-Day Support", value: "$400" },
  ],
  "4000": [
    { label: "Professional Design & Dev", value: "$1,500" },
    { label: "6–8 Pages + Booking System", value: "$800" },
    { label: "SEO, Analytics & CMS", value: "$600" },
    { label: "Hosting & Deployment", value: "$400" },
    { label: "60-Day Priority Support", value: "$700" },
  ],
  "5500": [
    { label: "Premium Design & Animations", value: "$2,200" },
    { label: "8–10 Pages + Blog & CMS", value: "$1,100" },
    { label: "Advanced SEO & Analytics", value: "$500" },
    { label: "Brand Strategy & Content", value: "$600" },
    { label: "90-Day Priority Support", value: "$1,100" },
  ],
  "7000": [
    { label: "Premium Custom Design", value: "$2,900" },
    { label: "10+ Pages + CMS Dashboard", value: "$1,400" },
    { label: "SEO, Analytics & Booking", value: "$1,100" },
    { label: "Copywriting & Brand Strategy", value: "$800" },
    { label: "90-Day Priority Support", value: "$800" },
  ],
  "8500": [
    { label: "Advanced Custom Development", value: "$3,500" },
    { label: "12+ Pages + Listings System", value: "$2,000" },
    { label: "Maps, Search & Lead Tracking", value: "$1,000" },
    { label: "SEO & Admin Panel", value: "$1,100" },
    { label: "120-Day Priority Support", value: "$900" },
  ],
  "10000": [
    { label: "E-Commerce Design & Dev", value: "$3,000" },
    { label: "Product Catalog & Cart", value: "$2,000" },
    { label: "Payments & Order Management", value: "$1,500" },
    { label: "SEO & Email Marketing", value: "$1,000" },
    { label: "120-Day Priority Support", value: "$2,500" },
  ],
};

export function getTemplateBreakdown(template: TemplateData): PriceBreakdownItem[] {
  const priceNum = template.price.replace(/[^0-9]/g, "");
  return breakdownsByTier[priceNum] || breakdownsByTier["2000"];
}

/** Returns a 1-7 tier level based on template price, for animation scaling */
export function getPriceTier(template: TemplateData): number {
  const priceNum = parseInt(template.price.replace(/[^0-9]/g, ""), 10);
  if (priceNum >= 10000) return 7;
  if (priceNum >= 8500) return 6;
  if (priceNum >= 7000) return 5;
  if (priceNum >= 5500) return 4;
  if (priceNum >= 4000) return 3;
  if (priceNum >= 3000) return 2;
  return 1;
}
