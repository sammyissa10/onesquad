...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <files>none</files>
  <action>
Human verifies the complete animation foundation: GSAP + Lenis smooth scroll with accessibility (prefers-reduced-motion) support, ScrollTrigger cleanup on route changes, and reusable useScrollAnimation hook.
...
15. Check browser console — no red errors related to GSAP, Lenis, hydration, or React
  ...
  <verify>User runs through the 15-step verification above and reports "approved" or describes issues.</verify>
